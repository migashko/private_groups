...
DATABASES = {
    'default': {
        ...
        'NAME': 'pg',                      # Or path to database file if using sqlite3.
        'USER': 'pg',                      # Not used with sqlite3.
...
SECRET_KEY = 'fm@*lx&l!&k#ar1cox%$7@(##cbilc71z$p7-(6jeg4sn@a1s5'
